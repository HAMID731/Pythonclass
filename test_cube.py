...
class TestCubeFunction(TestCase):
	...
	def test_that_cube_function_raise_exception_with_invalid_input(self):
		self.assertRaises(TypeError, cube.get_cube, "moses")

	def test_that_cube_function_return_correct_value_with_float(self):
		actual = cube.get_cube(2.3)
		expected = 12.167
		self.assertEqual(actual, expected)